...
torch.save(data_lst, f"../input_data/tsp/data_lst_{npoints}.pt")
torch.save(tour_lst, f"../input_data/tsp/tour_lst_{npoints}.pt")
torch.save(dist_lst, f"../input_data/tsp/dist_lst_{npoints}.pt")
torch.save(cost_lst, f"../input_data/tsp/cost_lst_{npoints}.pt")
torch.save(mst_perms, f"../input_data/tsp/W_{npoints}_mst.pt")
torch.save(output_tl, f"../input_data/tsp/cost_lst_{npoints}_mst.pt")
torch.save(output_tour, f"../input_data/tsp/tour_lst_{npoints}_mst.pt")
